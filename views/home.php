         ...
         <div class="row h-100">
            ...
            <div class="col-10">
               <div class="row search-bar">
                  <div class="input-group form-group col-5 mt-2">
                     <input class="form-control border-right-0" placeholder="Search">
                     <span class="input-group-append bg-white">
                     <button class="btn border border-left-0" type="button"><i class="oi oi-magnifying-glass"></i></button>
                     </span>
                  </div>
               </div>
